...
#  ifdef ESP8266
#    define RF_RECEIVER_GPIO 4 // 0 (D3) on nodemcu // put 4 (D2) with rf bridge direct mod
#  elif ESP32
...
#  ifdef ESP8266
#    define RF_EMITTER_GPIO 5 // 3 (RX) on nodemcu if it doesn't work with 3, try with 4 (D2) // put 5 (D1) with rf bridge direct mod
#  elif ESP32
